...
public class DFSPolyCubeCounterFixed2D {
	...
	public static final int NUM_NEIGHBOURS = NUM_ROTATIONS_2D;
	...
	public static final int NUM_2D_ROTATION_TYPES = 5;
	public static long debug2DRotationCounter[] = new long[NUM_2D_ROTATION_TYPES];
	...
	public static long doDepthFirstSearch(Coord3D cubesToDevelop[], boolean cubesUsed[][][], int numCellsUsedDepth,
		...
		for(int curOrderedIndexToUse=minIndexToUse; curOrderedIndexToUse<numCellsUsedDepth && cubesToDevelop[curOrderedIndexToUse] != null; curOrderedIndexToUse++) {
			...
			for(int dirNewCellAdd=0; dirNewCellAdd<NUM_NEIGHBOURS; dirNewCellAdd++) {
				...
				int new_k = cubesToDevelop[curOrderedIndexToUse].c;
				...
				if( ! cantAddCellBecauseOfOtherNeighbours) {
					...
					if(numCellsUsedDepth == cubesToDevelop.length - 1) {
						...
						int rot180Type = Debug2DRotations.getRotation180DegType(cubesToDevelop, cubesUsed);
						int rot90Type = Debug2DRotations.getRotation90DegType(cubesToDevelop, cubesUsed);
						
						if(rot90Type != -1) {
							System.out.println("Found 4-way rotational symmetry:");
							Utils.printCubes(cubesUsed, cubesToDevelop);
							
							debug2DRotationCounter[rot180Type]++;
							debug2DRotationCounter[rot90Type]++;
						} else if(rot180Type != -1) {
							//System.out.println("Found 2-way rotational symmetry:");
							//Utils.printCubes(cubesUsed, cubesToDevelop);
							
							debug2DRotationCounter[rot180Type]++;
							
						}
						//debug2DRotationCounter
	...
	public static void main(String args[]) {
		...
		//Fixed solutions for 2D: (This one starts at N=0 for some reason)
		...
		System.out.println("Debugging 2D rotations:");
		System.out.println("Number of rotations by type:");
		/*
		 * 
	public static final int NUM_2D_ROTATION_TYPES = 5;
	public static long debug2DRotationCounter[] = new long[NUM_2D_ROTATION_TYPES];
		 ...
		 */
		for(int i=0; i<NUM_2D_ROTATION_TYPES; i++) {
			System.out.println("Type " + i + ": " + debug2DRotationCounter[i]);
		}
